            ...
            function getTipueSearch(start, replace) {
                ...
                if (d.length >= set.minimumLength) {
                    ...
                    for (var i = 0; i < tipuesearch_in.pages.length; i++) {
                        ...
                        //var text_to_display = tipuesearch_in.pages[i].tags;
                        var text_to_search = tipuesearch_in.pages[i].text;
                        ...
                        for (var f = 0; f < d_w.length; f++) {
                            ...
                            if (set.highlightTerms) {
                                ...
                                text_to_search = text_to_search.replace(patr, "<b>$1</b>");
                            }
                        ...
                        if (score < 1000000000) {
                            found[c++] = score + '^' + tipuesearch_in.pages[i].title + '^' + text_to_search + '^' + tipuesearch_in.pages[i].loc;
                        }
                    }
                    ...
                    if (c != 0) {
                        ...
                        for (var i = 0; i < found.length; i++) {
                            ...
                            if (l_o >= start && l_o < set.show + start) {
                                ...
                                var index_of_search_term = t.indexOf('<b>');

                                var chars_before_search_term = 25;

                                var the_text_to_show = '';

                                var tokenized_result;
                                if (index_of_search_term < chars_before_search_term) {
                                    tokenized_result = t.split(' ');
                                } else {
                                    tokenized_result = t
                                        .slice(index_of_search_term - chars_before_search_term)
                                        .split(' ')
                                        .slice(1) //Remove the mangled first word
                                    ;

                                    tokenized_result.splice(0, 0, '...'); // prepend ellipsis
                                }

                                if (tokenized_result.length < set.descriptiveWords) {
                                    the_text_to_show = t;
                                }
                                    ...
                                    for (var f = 0; f < set.descriptiveWords; f++) {
                                        the_text_to_show += tokenized_result[f] + ' ';
                                    }
                                }
                                the_text_to_show = $.trim(the_text_to_show);
                                if (the_text_to_show.charAt(the_text_to_show.length - 1) != '.') {
                                    the_text_to_show += ' ...';
                                }
                                out += '<div class="tipue_search_content_text">' + the_text_to_show + '</div>';
